 ...
 * </p>
 * <ul>
 *   <li>{@link fr.unice.polytech.si5.polycreate.abstractsyntax.polycreate.impl.VariableImpl#getType <em>Type</em>}</li>
 *   <li>{@link fr.unice.polytech.si5.polycreate.abstractsyntax.polycreate.impl.VariableImpl#getInitialValue <em>Initial Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VariableImpl extends NamedELementImpl implements Variable {
	 ...
	 * @ordered
	 */
	protected static final VarType TYPE_EDEFAULT = VarType.INT;
	...
	protected EClass eStaticClass() {
		return PolycreatePackage.Literals.VARIABLE;
	}
	...
	public void setType(VarType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PolycreatePackage.VARIABLE__TYPE, oldType, type));
	}
	...
	public void setInitialValue(double newInitialValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PolycreatePackage.VARIABLE__INITIAL_VALUE,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case PolycreatePackage.VARIABLE__TYPE:
			return getType();
		case PolycreatePackage.VARIABLE__INITIAL_VALUE:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case PolycreatePackage.VARIABLE___INITIALIZE:
			initialize();
			return null;
		}
