...
/**
 * This is the item provider adapter for a {@link fr.unice.polytech.si5.polycreate.abstractsyntax.polycreate.Variable} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VariableItemProvider extends NamedELementItemProvider {
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Variable_type_feature",
								"_UI_Variable_type"),
						PolycreatePackage.Literals.VARIABLE__TYPE, true, false, false,
	...
	protected void addInitialValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Variable_initialValue_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Variable_initialValue_feature",
								"_UI_Variable_type"),
						PolycreatePackage.Literals.VARIABLE__INITIAL_VALUE, true, false, false,
